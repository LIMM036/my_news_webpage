...
db_info = {'db_name': 'financial_news',
           'username': 'likelion',
...
def send_sentiments():
    ...
    sentiment_datas = []
    for data in datas:
        date = datetime.strptime(data['pubDate'], '%a, %d %b %Y %X %z')
        ...
        sentiment_data = {'title': sentiment, 'start': date, 'color': color}
